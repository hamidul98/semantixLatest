...
const ToolsList = ({ onNavigateToEntityExplorer, onNavigateToTopicCluster }) => {
  const toolCategories = [
    {
      title: 'Semantic Keyword Research Tools',
      tools: [
        { name: 'Entity Explorer', icon: Search, description: 'Discover semantic entities and relationships', action: onNavigateToEntityExplorer },
        { name: 'Topic Cluster Generator', icon: Layers, description: 'Generate topic clusters for content planning', action: onNavigateToTopicCluster },
